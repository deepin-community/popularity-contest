...
sub read_result
{
  ...
  my (%pkg,%maintpkg,%sourcepkg,%sourcemax,%arch,%vendor,$numsub,%release);
...
EOF
  print HTML  <<'EOF';
<h2>Statistics per distributions reporting to Debian</h2>
<table border="0" cellpadding="5" cellspacing="0" width="100%">
<tbody>
<tr><td class="stats-cell">
<pre>
...
<td>
  <table>
    <tr><td>
      <img alt="Graph of distributions reporting to Debian"
       width="600" height="500" src="stat/vendors.png">
    </td></tr>
    <tr><td>
      <img alt="Graph of distributions reporting to Debian (12 last months)"
       width="600" height="500" src="stat/vendors-1year.png">
    </td></tr>
  </table>
</td>
</tr></table>
